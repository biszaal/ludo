 ...
 * vertical drift on springs — deliberately not an iOS edge-slide). Only the top
 * screen is mounted; screen state lives in stores, so remounting is safe.
 *
...
export function ScreenStack() {
  ...
  const entering =
    lastOp === "push"
      ? FadeInUp.springify().stiffness(100).damping(20)
      : lastOp === "pop"
        ? FadeInDown.springify().stiffness(100).damping(20)
        : FadeIn.duration(180);
